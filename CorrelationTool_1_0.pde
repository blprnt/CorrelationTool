...
String title1 = "2012";
String url1 = "SOTU2012.txt";
String desc1 = "SOTO";
String date1 = "January 24, 2012";
color color1 = #140047;

String title2 = "2011";
String url2 = "SOTU2011.txt";
String desc2 = "SOTU";
String date2 = "January 25, 2011";
color color2 = #680014;
...
boolean checkWord(String s) {
  ...
  String[] outs = {
    ...
    "does","kind","look","going","found","think","--","–-","know","applause","(applause","(applause}","man","guy","these","took","long","himself","well","-","—","our"
  };
  boolean safe = true;
